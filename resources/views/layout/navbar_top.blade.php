      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        <li class="ms-nav-item ms-search-form pb-0 py-0">
          <form class="ms-form" method="post">
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <img  style="width:25px; height:25px;" src="assets/img/icons/search.png" class="text-disabled mr-2" alt="">
        ...
        <li class="ms-nav-item dropdown">
          <a href="#" class="text-disabled ms-has-notification" id="mailDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="mr-2" style="width:30px; height:30px;" src="assets/img/icons/inbox.png" alt="">
          </a>
        ...
        <li class="ms-nav-item dropdown">
          <a href="#" class="text-disabled ms-has-notification" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="mr-2" style="width:25px; height:25px;" src="assets/img/icons/notifications.png" alt="">
          </a>
          <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="notificationDropdown">
            <li class="dropdown-menu-header">
              <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Notificaciones.</span></h6><span class="badge badge-pill badge-info">4 New</span>
            </li>
            <li class="dropdown-divider"></li>
            <li class="ms-scrollable ms-dropdown-list">
              <a class="media p-2" href="#">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="ms-dropdown-list">
              <div class="media">
                <a class=" fs-14 p-2" href="pages/prebuilt-pages/user-profile.html">
                  <img style="width:35px; height:35px;" src="assets/img/icons/man.png" alt="">
                  <span>Profile</span>
                </a>
              </div>
              <div class="media">
                <a class="fs-14 p-2" href="pages/apps/email.html">
                  <img style="width:35px; height:35px;" src="assets/img/icons/inbox.png" alt=""> 
                  <span>Inbox</span> <span class="badge badge-pill badge-info">3</span>
                </a>
              </div>
              <div  class="media">
                <a class="media fs-14 p-2" href="pages/prebuilt-pages/user-profile.html"> 
                <img class="mr-1" style="width:35px; height:35px;" src="assets/img/icons/cogwheel.png" alt=""> 
            ...
            <li class="dropdown-menu-footer">
              <div class="media">
                <a class="fs-14 p-2" href="pages/prebuilt-pages/default-login.html"> 
                <img class="mr-1" style="width:35px; height:35px;" src="assets/img/icons/logout.png" alt=""> 
                <span>Logout</span>
              </a>
              </div>
            </li>
