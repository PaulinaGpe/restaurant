    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#dashboard" aria-expanded="false" aria-controls="dashboard"> 
          <img class="mr-2" style="width:35px; height:35px;" src="assets/img/icons/speedometer.png" alt="">
          <span>Dashboard </span>
        </a>
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="home">Administrador</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#product" aria-expanded="false" aria-controls="product"> 
          <img class="mr-2" style="width:35px; height:35px;" src="assets/img/icons/price-list.png" alt="">
          <span>Menus </span>
        </a>
        <ul id="product" class="collapse" aria-labelledby="product" data-parent="#side-nav-accordion">
          <li> 
            <a href="carta">Menu Grid</a>
          </li>
        </ul>
      </li>
      <!-- product end -->
      ...
      <li class="menu-item">
        <a href="pages/orders.html"> 
          <img class="mr-2" style="width:35px; height:35px;" src="assets/img/icons/food-tray.png" alt="">
          <span>Orders</span>
        </a>
      </li>
      <!-- orders end -->
