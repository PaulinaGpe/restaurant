                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    ...
                    <div class="ms-card-body">
                      ...
                      <div class="new mb-0">
                        <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary">
                        	<img style="width:20px; height:20px;" src="assets/img/icons/bin.png" alt="">
                        	Remove
                        </button>
                        <button type="button" class="btn grid-btn mt-0 btn-sm btn-secondary">
                        	<img style="width:20px; height:20px;" src="assets/img/icons/pencil.png" alt="">
                        	Edit
                        </button>
                      </div>
                    </div>
